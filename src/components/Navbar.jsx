...
const Navbar = () => {
  ...
  const scrollToSection = (e, targetId, offset) => {
    e.preventDefault();
    ...
    >
      <nav className="flex items-center justify-between lg:px-10 px-3 py-6 w-full">
        <div className="flex items-center gap-1">
          ...
          <a href="/">
            <img className="w-14 hover:scale-110" src={logo} alt="logo" />
          </a>
        </div>
        <motion.div
          ...
          className={`absolute top-0 z-50 w-full lg:h-auto h-screen transition-all duration-300 
                        ${menuOpen
              ? "flex flex-col items-center justify-center backdrop-blur-3xl bg-black/90"
              : "hidden"
            } 
        ...
        >
          <a href="#About" onClick={(e) => scrollToSection(e, "About", 30)}>
            <motion.div
            ...
            >
              ...
              <span className="absolute bottom-0 left-0 w-full h-[2px] bg-green-400 group-hover:scale-x-100 scale-x-0 transition-transform duration-300 origin-left"></span>
            </motion.div>
          </a>
          <a
            href="#Technologies"
            onClick={(e) => scrollToSection(e, "Technologies", 120)}
          >
            <motion.div
              onClick={handleNavItemClick}
              whileHover={{ scale: 1.05 }}
          ...
          <a href="#Skills" onClick={(e) => scrollToSection(e, "Skills", 30)}>
            <motion.div
              onClick={handleNavItemClick}
              whileHover={{ scale: 1.05 }}
          ...
          <a href="#Works" onClick={(e) => scrollToSection(e, "Works", 22)}>
            <motion.div
              onClick={handleNavItemClick}
              whileHover={{ scale: 1.05 }}
          ...
          <a href="#Contact" onClick={(e) => scrollToSection(e, "Contact", 57)}>
            <motion.div
              onClick={handleNavItemClick}
              whileHover={{ scale: 1.05 }}
...
<div className="">
  <div className="flex gap-3">
    <a href="https://web.facebook.com/profile.php?id=100015780691706" target="blank">
      <button class="lg:w-9 lg:h-9 sm:w-8 sm:h-8 flex items-center justify-center rounded-lg bg-white/10 hover:bg-white/20 group transition-all duration-300">
        <svg class="transition-all duration-300 group-hover:scale-125 " xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 72 72" fill="none">
    ...
    <a href="https://www.instagram.com/nilushka_poornima/" target="blank">
      <button class="lg:w-9 lg:h-9 sm:w-8 sm:h-8 flex items-center justify-center group rounded-lg bg-white/10 hover:bg-white/20 group transition-all duration-300">
        <svg class="transition-all duration-300 group-hover:scale-125" width="28" height="28" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <a href="/" target="blank">
      <button class="lg:w-9 lg:h-9 sm:w-8 sm:h-8 flex items-center justify-center rounded-lg bg-white/10 group hover:bg-white/20 transition-all duration-300">
        <svg class="transition-all duration-300 group-hover:scale-125" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 72 72" fill="none">
    ...
    <a href="https://wa.me/94716843344" target="blank">
      <button class="lg:w-9 lg:h-9 sm:w-8 sm:h-8 flex items-center justify-center rounded-lg bg-white/10 hover:bg-white/20  group transition-all duration-300">
        <svg class="transition-all duration-300 group-hover:scale-125" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 71 72" fill="none">
    ...
    <a href="/" target="blank">
      <button class="lg:w-9 lg:h-9 sm:w-8 sm:h-8 flex items-center justify-center rounded-lg bg-white/10 hover:bg-white/20  group transition-all duration-300">
        <svg class="rounded-md transition-all duration-300 group-hover:scale-125" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 72 72" fill="none">
