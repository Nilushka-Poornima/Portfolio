    ...
    <div className="sm:flex sm:flex-col sm:items-center lg:flex lg:flex-row  md:gap-3 ">
      ...
      <div className="flex flex-col lg:items-start  lg:text-left lg:flex-grow  ">
        <div className="flex flex-col items-center text-justify lg:flex lg:flex-col lg:items-center w-full">
          <div className="border-b-2 relative flex flex-col items-center lg:items-start py-5 border-purple-950">

            <h1 className="text-4xl lg:text-6xl font-thin pb-8 ">
          ...
          {/* Paragraph Section */}
          <p className="py-2 mt-8 text-sm lg:text-base sm:text-base text-gray-300 max-w-sm lg:max-w-lg lg:text-justify sm:text-center">
            {HERO_CONTENT}
          </p>
      ...
      <div className="flex flex-col items-center w-full lg:w-auto lg:mr-16">
        <img
          src={profilePic}
          alt="Profile"
          className="w-32 h-32 lg:w-96 lg:h-96 rounded-3xl object-cover shadow-lg"
        />
      </div>
    </div>
  );
